        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{route('dashboard')}}"><img src="assets/images/logo" alt="Your Logo"></a>
                <a class="navbar-brand brand-logo-mini" href="{{route('dashboard')}}"><img src="assets/images/logo" alt="" ></a>
            </div>
            <!-- Top bar left -->
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="{{asset('assets/dashboard/assets/images/profile-avatar.jpg')}}" alt="avatar">
                    </a>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <x-dropdown  width="48">
                                ...
                                <x-dropdown-link :href="route('register')">
                                    <i class="text-warning ti-plus"></i>    {{ __('Add New Admin') }}
                                </x-dropdown-link>


                                <x-dropdown-link :href="route('profile.edit')">
                                    <i class="text-warning ti-user"></i>    {{ __('Profile') }}
                                </x-dropdown-link>
